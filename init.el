...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (py-isort jedi add-node-modules-path rjsx-mode git-gutter-fringe diff-hl wgrep magit-gitflow tide typescript-mode ddskk elpa-mirror recentf-ext color-moccur cygwin-mount w3 htmlize yaml-mode php-mode csv-mode magit helm-swoop migemo web-mode msvc helm-gtags company-irony cmake-mode)))
